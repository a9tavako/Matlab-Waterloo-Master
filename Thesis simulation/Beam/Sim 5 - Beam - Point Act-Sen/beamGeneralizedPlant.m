function [A,B1,B2,C1,C2,D11,D12,D21,D22] = beamGeneralizedPlant(Length,NumNode,Stiffness,Mu,KVDamp,VisDamp,...
                                                                ActLoc,SenLoc,...
...
[A,B2,C2] = beamMatrixABC(Length,NumNode,Stiffness,Mu,KVDamp,VisDamp,ActLoc,SenLoc);
