clear all;cla;clc;clf
numnode = 10;  % number of modes

numSen  = 20;  % num of positions available for sensor, evenly spaced
...
xlabel('Sensor Position on ');
ylabel('H_2 Cost)');
title('Effect of Damping - Actuator width 0.05');
