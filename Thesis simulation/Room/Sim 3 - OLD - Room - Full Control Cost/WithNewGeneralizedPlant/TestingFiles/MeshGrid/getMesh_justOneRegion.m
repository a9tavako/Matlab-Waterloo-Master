function [p,e,t]  = getMesh_justOneRegion(heatX,heatY,heatdx,heatdy,...
...
[p,e,t]               = initmesh(geom, 'Hmax',inf)                            ; % makes the mesh;
if wantRefinedMesh == 1
    [p,e,t]           = refinemesh(geom,p,e,t)              ; % refine all of the mesh
end
if refineActSen == 1
