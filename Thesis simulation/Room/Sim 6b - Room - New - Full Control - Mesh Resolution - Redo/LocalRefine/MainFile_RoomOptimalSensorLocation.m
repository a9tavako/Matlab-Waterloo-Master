clear all; clc;clf;
%610 seconds for 0.05, 180 seconds for 0.1
tic
xRes   = 0.1;
yRes   = 0.1;
...
for counterX = 1:length(senXPos)
    ...
    [p,e,t,boundaryPointsIndex,windowPointsIndex,heaterPointsIndex,sensorPointsIndex] = getMeshForLocalRefinement(heatX,heatY,heatdx,heatdy,...
