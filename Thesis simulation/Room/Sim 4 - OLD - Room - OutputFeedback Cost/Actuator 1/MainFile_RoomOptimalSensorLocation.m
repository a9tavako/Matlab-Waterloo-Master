clear all; clc;
heatX  = 0.15; %coord for center of heater
heatY  = 0.5;
heatdx = 0.05; %half width of heater
heatdy = 0.45;
...
for counterX = 1:length(senXPos)
    ...
    [A,B1,B2,C1,C2,D11,D12,D21,D22] = getRoomGeneralizedPlant(p,e,t,a,c,f,...
                                           disturbStrength,actStrength,...
                                           stateWeightInCost,controlWeightInCost,...
                                           stateWeightInSen,disturbWeightInSen);
    
    h2scores(counterX,counterY) = calculateOptimalH2OutputFeedbackCost(A,B1,B2,...
