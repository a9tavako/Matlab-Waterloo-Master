function [A,B1,B2,C1,C2,D11,D12,D21,D22] = getRoomGeneralizedPlant_Normalized(p,e,t,xRes,yRes,...
...
B1 = B1/(norm(B1)*sqrt(xRes*yRes));
B1 = B1*disturbStrength;
