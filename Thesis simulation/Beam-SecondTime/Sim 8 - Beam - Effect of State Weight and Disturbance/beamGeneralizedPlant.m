...
dx   = 0.001;
x    = 0:dx:L;
f    = 10*exp((-1/2)*((x-mean)/sig).^2); %Disturbance a normalized gaussian function
...
D12(N+1,1) = ControlStrengh;
D21        = [0,1]*DistWeightOnMeasurement;  %must have full row rank
